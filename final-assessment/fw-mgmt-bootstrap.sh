...
set firewall ipv4 name LAN-to-MGMT rule 10 description 'Allow AD/DNS from LAN to mgmt02 (DC)'
...
set firewall ipv4 name LAN-to-MGMT rule 25 description 'Allow AD CS Web Enrollment on mgmt02 (CA on DC)'
set firewall ipv4 name LAN-to-MGMT rule 25 destination address '172.16.200.11'
